...
export const POST_RESET_PASS_SUCCESS: 'POST_RESET_PASS_SUCCESS' = 'POST_RESET_PASS_SUCCESS';
...
export const CHANGE_COUNT_BUN: 'CHANGE_COUNT_BUN' = 'CHANGE_COUNT_BUN';
export const INCREASE_COUNT: 'INCREASE_COUNT' = 'INCREASE_COUNT';
export const DECREASE_COUNT: 'DECREASE_COUNT' = 'DECREASE_COUNT';
export const REMOVE_COUNTS: 'REMOVE_COUNTS' = 'REMOVE_COUNTS';
...
export const ADD_UNLOCKED_INGREDIENT: 'ADD_UNLOCKED_INGREDIENT' = 'ADD_UNLOCKED_INGREDIENT';
export const DELETE_ALL_INGREDIENTS: 'DELETE_ALL_INGREDIENTS'= 'DELETE_ALL_INGREDIENTS';
export const UPDATE_UNLOCKED: 'UPDATE_UNLOCKED' = 'UPDATE_UNLOCKED';
